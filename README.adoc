...
- _*Daily Scrum*_ cada 2 días: los integrantes del equipo tienen tiempos diferentes y un día de trabajo quizá no sea suficiente para tener un avance considerable para plantearlo en las _Daily_. Por incovenientes o bloqueo de un integrante, en el día que no hay _Daily_, se comunicarán por algunos de los medios detallados más adelante.
...
*Email* En caso de que sea necesario, por algún incoveniente externo que no permita las vías convencionales, utilizaremos el mail de los integrantes para coordinar al equipo. Además, es la principal vía para comunicarnos con nuestro Product Owner.
...
Utilizaremos los _Issue_ de _GitHub_ para reportar bugs. Además se agregarán al tablero Jira de los PO, SM y LT. Posteriormente a un (Trello/Jira) de nuestro equipo para gestionar el estado el bug.
