...
|Ausencia de miembros del equipo en fechas 2023-10-05, 2023-11-02, 2023-06-11 por motivos de estudio|3|3|9|Definir reemplazantes, planificar ausencias|Reemplazos| Villalba, Gastón
|||||||
|||||||
|||||||
|||||||
