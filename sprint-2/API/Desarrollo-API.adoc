...
== Desarrollo
Para la implementación de la API se utilizó el 
Framework de Flask y distintas librerias necesarias para la utilización del modelo y para la manipulación de imágenes. 
