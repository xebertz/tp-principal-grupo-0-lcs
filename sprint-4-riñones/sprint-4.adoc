...
Se puede notar que los _story points_ restantes son 137 y no 122 como se tenía previsto, esto se debe a que, en el gráfico, se contempla la reuión formal y la _retrospective_ del equipo, sumando así los **15 _story points_** restantes.
...
.Horas imputadas de cada rol en el proyecto
