...
Mediante el id asociada a una imagen/prediccion se obtienen los datos de la predicción y feedback en formato JSON. 

ruta = `https://averiapi-4vtuhnxfba-uc.a.run.app/retrieve`
